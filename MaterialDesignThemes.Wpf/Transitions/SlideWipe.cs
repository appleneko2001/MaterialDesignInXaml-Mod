...
namespace MaterialDesignThemes.Wpf.Transitions
{
    ...
    {        
        private readonly EasingFunctionBase _Ease = new PowerEase() {  Power = 4  };
        ...
        public void Wipe(TransitionerSlide fromSlide, TransitionerSlide toSlide, Point origin, IZIndexController zIndexController)
        {
            ...
            //var fromOpacityAnim = new DoubleAnimationUsingKeyFrames();// new EasingDoubleKeyFrame(1, endKeyTime, _Ease);
            //fromOpacityAnim.KeyFrames.Add(new LinearDoubleKeyFrame(1, zeroKeyTime));
            //fromOpacityAnim.KeyFrames.Add(new EasingDoubleKeyFrame(0, endKeyTime, _Ease));
            ...
            fromXAnimation.KeyFrames.Add(new EasingDoubleKeyFrame(fromEndX, endKeyTime, _Ease));
            ...
            fromYAnimation.KeyFrames.Add(new EasingDoubleKeyFrame(fromEndY, endKeyTime, _Ease));
            ...
            toXAnimation.KeyFrames.Add(new EasingDoubleKeyFrame(toEndX, endKeyTime, _Ease));
            ...
            toYAnimation.KeyFrames.Add(new EasingDoubleKeyFrame(toEndY, endKeyTime, _Ease)); 
            // Set up events
            ...
            //fromSlide.BeginAnimation(UIElement.OpacityProperty, fromOpacityAnim);
