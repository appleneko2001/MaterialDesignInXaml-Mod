...
namespace MaterialDesignThemes.Wpf.Transitions
{
    ...
    public class TransitionerSlide : TransitioningContentBase
    {
        ...
        public static readonly DependencyProperty ForwardWipeProperty = DependencyProperty.Register(
            "ForwardWipe", typeof(ITransitionWipe), typeof(TransitionerSlide), new PropertyMetadata(new SlideWipe() { Direction = SlideDirection.Left }));
        ...
        public static readonly DependencyProperty BackwardWipeProperty = DependencyProperty.Register(
            "BackwardWipe", typeof(ITransitionWipe), typeof(TransitionerSlide), new PropertyMetadata(new SlideWipe() { Direction = SlideDirection.Right }));
